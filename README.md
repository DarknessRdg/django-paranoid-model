...
All documentation is in the `docs` directory and online at [HERE !!](https://github.com/DarknessRdg/django-paranoid-model/). If you're new here, we recomend you to checkout the documentation first :wink: .
